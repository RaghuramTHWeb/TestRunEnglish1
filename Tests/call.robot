...
Opening Chrome In Incognito Mode and Login as Provider
    [Documentation]    Opens Chrome in incognito mode and logs in as a provider
    Open Browser    https://app-dev.taskhuman.com/login    Chrome    alias=INC    options=add_argument("--incognito")
    Set Window Size    650    1050
...
Take Provider Online and Will Fail If Already Online
...
Login as Consumer
    ...
    Open Browser    https://app-dev.taskhuman.com/login    Chrome    alias=NORM    #alias to switch broswer
    Set Window Size    625    1050
    Set Window Position    625    0
