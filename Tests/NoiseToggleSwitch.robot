...
Accept Call as Provider in Incognito
    ...
    Wait Until Element Is Visible    xpath=//div[@class='UserControl-module__UserControls']//img[5]    6s
    Click Element    xpath=//div[@class='UserControl-module__UserControls']//img[5]
    Wait Until Element Is Visible    xpath://*[text()='Noise Reduction']    2s
        Click Element    xpath://*[text()='Noise Reduction']
    Wait Until Element Is Visible    xpath=//span[@class='chakra-switch__thumb css-7roig']    3s
    Click Element    xpath=//span[@class='chakra-switch__thumb css-7roig']
        Sleep    99s
