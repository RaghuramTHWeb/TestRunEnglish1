...
Login as Consumer
    ...
    Click Element    xpath://button[@value='submit']
    Sleep    4s
Goto provider profile and place call for 10 min
    Go To    https://app-dev.taskhuman.com/profile/5466
    Sleep    3s
    Wait Until Element Is Visible    xpath=//img[@src='/a2f456af5324fe21e600.svg' and contains(@class, 'chakra-image css-0')]    10s
    Click Element    xpath=//img[@src='/a2f456af5324fe21e600.svg' and contains(@class, 'chakra-image css-0')]
    Sleep    5s
...
Decrement Value Until 10 and call
