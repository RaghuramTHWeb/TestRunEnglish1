...
Validate Programs and Scrolling
...
Validate Programs Visibility
    ...
    Click Element    css=.DiscoverTab-module__Header--tab:first-child
    Wait Until Element Is Visible    css=.DiscoverTab-module__Header--tab:last-child    5s
    Click Element    css=.DiscoverTab-module__Header--tab:last-child
