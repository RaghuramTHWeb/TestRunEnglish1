...
Goto settings and validate terms and conditions page redirection and content
        Wait Until Element Is Visible    xpath://a[@href='/settings']    5s
        Click Element    xpath://a[@href='/settings']
        Sleep    3s
        Wait Until Element Is Visible    xpath://p[@class='SettingsRoute-module__active']    5s
        Click Element    xpath://p[@class='SettingsRoute-module__active']
        Sleep    3s
        Wait Until Page Contains    Terms and Conditions    5s
        Click Element    xpath=//*[contains(text(), 'Terms and Conditions')]
        Sleep    3s
        Wait Until Element Is Visible    xpath://a[normalize-space()='Terms and Conditions']    5s
...
To validate Privacy policy section
        Wait Until Page Contains    Privacy Policy    5s
        Click Element    xpath=//*[contains(text(), 'Privacy Policy')]
        Sleep    3s
        Wait Until Element Is Visible    xpath://a[normalize-space()='Privacy Policy']    5s
...
To validate App feedback section
        ...
        Sleep    3s
        Wait Until Element Is Visible    xpath://*[text()='ask@taskhuman.com']    3s
        Sleep    3s
To validate Notification settings section
        Go To    https://app-dev.taskhuman.com/settings/notification-settings
        Wait Until Element Is Visible    xpath://p[@class='chakra-text SettingComponents-module__How--Notification--Work--Text css-0']    6s
        Sleep    3s
    Close Browser
